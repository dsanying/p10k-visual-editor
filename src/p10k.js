export const segmentExamples = {
  ...
  laravel_version: ['laravel 11.0.0', '不显示 Laravel 版本'],
  ...
  load: ['load 0.62', '不显示 CPU 负载'],
  disk_usage: ['disk 41%', '不显示磁盘用量'],
  ram: ['ram 5.2G', '不显示可用内存'],
  swap: ['swap 0.3G', '不显示交换分区用量'],
...
export const fallbackCatalog = [
  ...
  ['laravel_version', 'Laravel 版本', '显示 Laravel PHP 框架版本'],
  ...
  ['load', 'CPU 负载', '显示最近一段时间的 CPU 负载'],
  ['disk_usage', '磁盘用量', '显示磁盘空间使用情况'],
  ['ram', '可用内存', '显示内存占用或可用内存'],
  ['swap', '交换分区', '显示 swap 使用量'],
  ['time', '当前时间', '显示当前时间'],
  ['ip', '内网 IP', '显示 IP 和带宽'],
  ...
  ['example', '示例自定义段', '显示 .p10k.zsh 中的示例自定义 segment'],
];
